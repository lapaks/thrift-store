...
- Works with DISQUS
- Custom Background
- Post formats (Aside, Quote, Link and Image)
- Custom Header
- Custom Menus in Header & Footer
- Powerful Theme Framework with more than 30 options
- Layout Options
- Custom Logo Image & Favicon
- full width template
- Finally: Choose custom colors for your elegantWhite Pro with the new color picker!
- Now you can choose Post Thumbnails for your articles
...
An awesome theme for an amazing price! Get it now for just $12.99!

—> http://fimply.de/themes/elegantwhite-pro <—

---

=== CHECK OUT OUR FULL COLLECTION OF THEMES ===

Just visit http://fimply.de/themes
...
Become a fan of us for updates on elegantWhite: http://facebook.com/fimply.themes
...
Note: elegantWhite doesn't support multi level drop downs. We're listing all items as parent menu items. 

Upgrade to elegantWhite Pro for full drop-down menu support.
...
elegantWhite WordPress Theme, Copyright 2014 Fimply.de
